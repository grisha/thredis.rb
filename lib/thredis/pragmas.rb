...
module Thredis
  ...
  # defines convenience methods for the various pragmas supported by Thredis.
  #
  # For a detailed description of these pragmas, see the Thredis documentation
  ...
  module Pragmas
    ...
    # Thredis::Exception will be raised. Otherwise it
    # returns silently.
    def integrity_check

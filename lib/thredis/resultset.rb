...
thredis version 2.0.0, please call the `types` method on the Thredis::ResultSet
...
thredis version 2.0.0, please call the `columns` method on the Thredis::ResultSet
object that created this object
        eowarn
        @fields
      end
